...
class SupplierRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'phone' => ['required','max:20',Rule::unique('suppliers')->ignore($this->supplier)],
    ...
    {
        return [
            'supplier_name.required' => 'Nama harap diisi',
            'supplier_name.max' => 'Kolom Nama tidak boleh lebih dari 50 karakter',
