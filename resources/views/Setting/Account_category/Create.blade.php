...
@section('title',$title)
@section('content')
<form action="{{ url('setting/account_category') }}" method="post">
    @csrf
    ...
    <div class="card-body">
        ...
        <div class="form-group">
            ...
            <select name="sub_header_id" class="form-control @error('sub_header_id') is-invalid @enderror">
                ...
                <option value="{{ $value->id }}" @if ( $value->id == old('sub_header_id')   ) selected @endif>{{ $value->sub_header_code.' - '.$value->account_header->header_name.' - '.$value->header_sub_name }}</option>
                @endforeach
            </select>
            @error('sub_header_id')
        ...
        <div class="form-group">
            ...
            <input type="text" name="category_code" value="{{ old('category_code') }}" class="form-control @error('category_code') is-invalid @enderror">
            @error('category_code')
                <span class="error invalid-feedback">{{ $message }}</span>
            @enderror
        </div>
        ...
        <div class="form-group">
            ...
            <input type="text" name="categories_name" value="{{ old('categories_name') }}" class="form-control @error('categories_name') is-invalid @enderror">
